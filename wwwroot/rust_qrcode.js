...
* @param {number} rect_size
* @param {number} point_x
* @param {number} point_y
* @returns {string}
*/
export function zoom_img(image_data, rect_size, point_x, point_y) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.zoom_img(retptr, ptr0, len0, rect_size, point_x, point_y);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rust_qrcode_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
